...
These Terms of Use ("Terms") govern your access to and use of the Komand mobile application ("App"), developed and published by Paulius Masalskas ("Developer", "we", "us", or "our"). By downloading, installing, or using the App, you agree to these Terms. If you do not agree, do not use the App.
...
- expanded usage and runtime defaults
- repository and git actions from iPhone
- voice dictation
...
To provide the App Store experience, Komand may operate hosted services such as:
...
Portions of the Komand stack may be published in public source form. Source-code use is governed by the applicable repository license. These Terms apply to the distributed mobile application and any related services we operate for it.

## 9. Intellectual Property

The Komand name, branding, and app presentation are owned by the Developer, except for third-party marks belonging to their respective owners. Nothing in these Terms grants you rights to our branding beyond normal use of the App.
...
These Terms are governed by the laws of Singapore, without regard to conflict-of-law rules. Any dispute relating to these Terms will be resolved in the courts of Singapore, unless applicable law requires otherwise.
